...
class Train:
    ...
    def __init__(self,root):
        ...
        # ------------------------------------------------------------------------------------------------------------------- 
        # Training button 1
        std_img_btn=Image.open(r"C:\Users\Administrator\Downloads\attendance_miniproject\python_code\imagesproj\datatrain.jpg")
    ...
    def train_classifier(self):
        # data_dir = os.path.join(os.path.dirname(__file__), 'data_img')
        data_dir=("data_img")
